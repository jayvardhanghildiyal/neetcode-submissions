...
class Solution {
    public void setZeroes(int[][] matrix) {
        ...
        // in essense, matrix[0][0] keeps track of what needs to be done with the first column
        // and firstRow keeps track of what needs to be done to the first row
        // because we have a lot of cases, storing the fate of both in separate places makes sense
        if (firstRow) {
            for (int j = 0; j < cols; j++) {
                matrix[0][j] = 0;
            }
